...
-- More convenient key to switch to previous buffer
vim.keymap.set('n', '<C-CR>', '<C-^>', { desc = 'Switch to previous buffer' })
vim.keymap.set('n', ';;', '<C-^>', { desc = 'Switch to previous buffer' })
...
-- Don't display line numbers in terminal windows
